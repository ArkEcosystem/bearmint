...
describe<{
	...
	it('should handle the strategy', async (context) => {
		...
		expect(context.delegator1.balances[denominations.reward].toString()).toStrictEqual('80000000')
		...
		expect(context.delegator2.balances[denominations.reward].toString()).toStrictEqual('20000000')
	})
})
