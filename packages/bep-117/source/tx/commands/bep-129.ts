...
export class BEP129Command extends TxCommand {
	public static override paths = [['tx', 'bep-129']]

	public readonly description = 'Submit an `NFT Collection Permission Grant` Tx'
	...
	public readonly permissions = Option.String('--permissions', {
		description: 'A comma-separated list of permissions to grant to the steward',
		required: true,
		validator: t.isString(),
	})

	public readonly steward = Option.String('--steward', {
		description: 'The address of the account to grant permissions to',
		required: true,
		validator: t.isString(),
	})
