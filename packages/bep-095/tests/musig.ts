...
import type { Signature, SignatureFactory, SignatureStruct } from '@bearmint/bep-013'
...
export function makeSignature({ hash, publicKey, signature }: SignatureStruct): Signature {
	return {
		toBytes() {
			return signature
		},
